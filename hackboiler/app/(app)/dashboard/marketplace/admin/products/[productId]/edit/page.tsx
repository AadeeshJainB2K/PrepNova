...
import { updateProduct } from "@/lib/marketplace/admin-actions";
...
export default async function EditProductPage({
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Form */}
      <form action={handleUpdate} className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
        <div className="space-y-6">
          {/* Product Name */}
          <div>
